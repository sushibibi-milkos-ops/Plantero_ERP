...
## Ekranlar
0. Hatlar: `docs/PRODUCTION-LINES.md` (3 hat, proses adımları). 
...
4. `/uretim/hatlar` — 3 kart (HAT1/HAT2/HAT3, docs/PRODUCTION-LINES.md): hat adı, durum (çalışıyor/boşta/duruşta), aktif WO, bugünkü üretim, bugünkü OEE (oee_records varsa), son duruş.
