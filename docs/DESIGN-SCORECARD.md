...
7. **Yakınsama zorunluluğu:** Bir route toplamı referansın altındaysa kritik, yalnızca P0/P1 hataları değil, **4 puanlı her kriter için o kriteri 5'e çıkaracak ölçülebilir bulguyu** da açar (kapandığında toplam ≥ referans olacak kadar; `criterion` alanı zorunlu). "Açık bulgu yok ama route kaybediyor" durumu protokol ihlalidir. Builder bu bulguları da kapatır; kapanan bulgunun kriteri bir sonraki turda 5'e çıkmıyorsa kritik gerekçesini `scoreNotes`'a yazmak zorundadır.
