 ...
 *   pnpm tsx scripts/probe-bildirimler-r8.ts  → artifacts/critic/probe-bildirimler-r12.json */
...
async function main() {
  ...
  const p = resolve(process.cwd(), 'artifacts/critic/probe-bildirimler-r12.json');
