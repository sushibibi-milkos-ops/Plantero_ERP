/** Tur 16 kokpit prob (b): rozet anatomisi + kolon dibi + KPI şerit genişliği (data-status / kpi kökü). */
...
async function main() {
  ...
  await browser.close();
  writeFileSync(resolve(OUT, 'probe-r16b.json'), JSON.stringify(out, null, 2));
  console.log('yazıldı');
}
main();
