/** Tur 10 ihracat ölçüm probu: sütun genişliği/dolu oranı/distinct, hover-focus, boş durum. */
...
async function main() {
  ...
  await ctxm.close();
  await browser.close();
  writeFileSync('artifacts/critic/probe-ihracat-r10.json', JSON.stringify(res, null, 1));
  console.error('ok');
}
