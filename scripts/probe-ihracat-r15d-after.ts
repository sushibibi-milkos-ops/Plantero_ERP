/** Tur 15 (bu oturum) dogrulama: chain.ts TYPE_RANK duzeltmesi sonrasi zincir kart sirasi. */
...
async function main() {
  ...
  writeFileSync('artifacts/critic/probe-ihracat-r15d-after.json', JSON.stringify(res, null, 2));
